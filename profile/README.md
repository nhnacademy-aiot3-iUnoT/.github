...
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| <img width="120" alt="image" src="https://github.com/user-attachments/assets/a561aeea-d291-4472-8fc1-66bfad945f76" /> | <img width="120" alt="image" src="https://github.com/user-attachments/assets/46de16f8-b91d-48c9-8833-9ef9437d0aee" /> | <img width="120" alt="image" src="https://github.com/user-attachments/assets/1f861ac0-deca-4b46-9a24-f15f95d78071" /> | <img width="120" alt="rule" src="https://github.com/user-attachments/assets/a4d38ef4-248f-4087-8e87-fc0f275aa438" /> | <img width="120" alt="image" src="https://github.com/user-attachments/assets/4fd6c704-48fe-4671-8dca-a3b0f9a3a31e" /> | <img width="120" alt="image" src="https://github.com/user-attachments/assets/4c0548dd-28f4-4bad-8b17-a147823c385c" /> | <img width="120" alt="alert" src="https://github.com/user-attachments/assets/667c2710-81e2-4756-bba5-5560ca3b7b53" /> | <img width="120" alt="image" src="https://github.com/user-attachments/assets/2c04bb35-a335-4cb4-8d3d-4e7e3910f13b" /> |
| **인프라 · AI** | **조직관리 · AI** | **재고관리** | **룰 엔진** | **인증/인가**<br>**룰 엔진** | **룰 엔진 · AI** | **재고관리 · 알림** | **재고관리** |

---

## 🧑‍💻 프로젝트 소개

#### 기간 : 2026.07.06 ~ 2026.09.22

- iUnoT는 IoT 센서를 활용하여 의약품의 보관 환경과 재고를 통합 관리하는 조직 단위 플랫폼입니다.
...
- 조직 및 부서 기반의 데이터 접근 관리
- AI 기반 재고·환경 분석 및 운영 지원
...
- 재고 데이터를 기반으로 한 주간 리포트
- 환경 데이터를 기반으로 한 주간 리포트
- 재고 및 환경 현황에 대한 AI 챗봇
- 자연어 기반 데이터 조회 및 정보 제공

---

## 🌐 시스템 구조

> MSA 기반 구조로 구성되며, Gateway를 통해 인증, 조직, 재고, 룰 엔진, AI 등의 서비스를 분리하여 제공합니다.
